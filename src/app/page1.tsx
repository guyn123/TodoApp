...
// // // import { getTodos, updateTodo, deleteTodo, deleteManyTodos, PagedResponse, TodoResponse } from '@/api/backend/todo';
...
// // //   // Hàm load dữ liệu từ backend với phân trang, tìm kiếm, filter
// // //   const loadTodos = async () => {
// // //     if (!token) return;
// // //     try {
// // //       const data: PagedResponse<TodoResponse> = await getTodos(
// // //         token,
// // //         page,
// // //         pageSize,
// // //         searchTerm,
...
// // //       // Filter "expired" xử lý tại frontend
// // //       if (filter === 'expired') {
...
// // //   }, [isAuthenticated, token, page, pageSize, searchTerm, filter]);
...
// //   const { data: getTodoRepsonse } = useQuery({
// //     queryKey: ["TODOS", page, pageSize],
// //     queryFn: () => getTodos(token!, page, pageSize),
// //     enabled: !!token
// //   })

// //   const { content, page: currentPage, totalElements: currentTotalElements } = getTodoRepsonse || {};

// //   console.log({ getTodoRepsonse })
...
// //       render: (priority: ITodo['priority']) => {
// //         const colorMap: Record<ITodo['priority'], string> = {
// //           Low: "titlelogo": "Ứng dụng để quản lý công việc",,
// //           Medium: '#1890ff',
// //           High: '#faad14',
// //           Urgent: '#f5222d',
// //         };
...
//           Urgent: '#f5222d',
//         };
//         return <span style={{ color: colorMap[priority], fontWeight: 'bold' }}>
...
//         <Divider />
//         <AddTodoForm messageApi={messageApi} />
//         <SearchTodo onSearch={setSearchTerm} /> {/* debounce search */}
//         <TodoStatusFilter />
//         <TodoActions
//           todos={todos}
//           selectedIds={selectedIds}
